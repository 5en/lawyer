...
public class NormalViewHolder {
    ...
    public NormalViewHolder setImageDisplay(int viewId, String url) {
    ...
    public NormalViewHolder setOnItemClickListener(int viewId, AdapterView.OnItemClickListener listener) {
        mHolderImpl.setOnItemClickListener(viewId, listener);
        return this;
    }

    public NormalViewHolder setOnItemLongClickListener(int viewId, AdapterView.OnItemLongClickListener listener) {
        mHolderImpl.setOnItemLongClickListener(viewId, listener);
        return this;
    }

    public NormalViewHolder setOnItemSelectedClickListener(int viewId, AdapterView.OnItemSelectedListener listener) {
    ...
    public NormalViewHolder post(int viewId, Runnable action) {
        mHolderImpl.post(viewId, action);
        return this;
    }

    public NormalViewHolder removeAllViews(int viewId) {
        mHolderImpl.removeAllViews(viewId);
        return this;
    }
}
