...
/**
 * 作者：yzb on 2016/10/10 15:23
 * 邮箱：280766447@qq.com
 */
public class LawyerServiceAdapter extends CommonAdapter<String> {
    public LawyerServiceAdapter(Context context, List<String> data, int layId) {
