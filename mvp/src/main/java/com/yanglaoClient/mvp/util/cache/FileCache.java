 ...
 */
package com.yanglaoClient.mvp.util.cache;
...
public class FileCache {
	...
	public static class TACacheParams {
		...
		public TACacheParams(Context context, String uniqueName) {
			if (AndroidVersionCheckUtils.hasGingerbread()) {
				diskCacheDir = ExternalOverFroyoUtils.getDiskCacheDir(context,
						uniqueName);
			} else {
				diskCacheDir = ExternalUnderFroyoUtils.getDiskCacheDir(context,
						uniqueName);
			}
		}
