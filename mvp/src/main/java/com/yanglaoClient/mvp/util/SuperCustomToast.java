...
/**
 * Do Good App 项目名称：MyApplication 类描述：超级自定义的Toast,单例模式获取本类 创建人：likh
 * 创建时间：15/10/15 19:23 修改人：likh 修改时间：15/10/15 19:23 修改备注：
 */
public class SuperCustomToast {
	...
	public void show(String msg, int layoutId, int rootId, Activity activity) {
		...
		layout = inflater.inflate(layoutId, (ViewGroup) activity.findViewById(rootId));
	...
	protected Animation getEndAnimation() {
		...
		TranslateAnimation animTrans = new TranslateAnimation(Animation.RELATIVE_TO_PARENT, 0f,
				Animation.RELATIVE_TO_PARENT, -1.5f, Animation.RELATIVE_TO_PARENT, 0f, Animation.RELATIVE_TO_PARENT,
				0f);
